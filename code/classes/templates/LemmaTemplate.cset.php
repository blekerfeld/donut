...
class pLemmaTemplate extends pEntryTemplate{
	...
	public function parseTranslations($translations, $justList = false){
		...
		// $showAll = ((isset(pRegister::session()['returnLanguage'])) ? '<a class="opacity-min float-right" href="'.p::Url("?entry/".$this->_data['id']."/resetTranslations/").'">'.LEMMA_TRANSLATIONS_RESET.'</a>' : '');
		$showAll = '';
