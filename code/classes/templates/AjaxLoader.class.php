...
class pAjaxLoader extends pTemplatePiece{
	...
	public function __toString(){
		...
		$output = (($this->_loadOnClick == false AND is_array($this->_clickButton)) ? '' : "<a href='javascript:void(0);' class='ssignore click$id ".$this->_clickButton[0]."'>".$this->_clickButton[1]."</a>")."<div id='$id' class='$this->_wrapperclass ".(($this->_loadOnClick == true) ? 'hide ' : '')."'>".pMainTemplate::loadDots()."</div>".($this->_refresh ? "
