...
class pAjaxLoader extends pTemplatePiece{
	...
	public function __toString(){
		...
		$output = (($this->_loadOnClick == false AND is_array($this->_clickButton)) ? '' : "<a class='ssignore click$id ".$this->_clickButton[0]."'>".$this->_clickButton[1]."</a><br />")."<div id='$id' class='$this->_wrapperclass ".(($this->_loadOnClick == true) ? 'hide ' : '')."'><center><p class='dots'><span>.</span><span>.</span><span>.</span></p></center></div>".($this->_refresh ? "
