...
class pTwolcString{
	...
	public function toDebug(){
		//return $this->_string;
		return "Surface level ".strtolower(str_replace(array('0', '+', '{', '::', ':', '&', '#'), '', $this->_string))."<br /> Corrected:&emsp; ".$this->_string."<br /> Generated by inflection:&emsp; ".$this->_orginalString.'';
	}

	public function toRulesheet(){
		//return $this->_string;
		return "<table class='describe'><tr class='title'><td>Surface level</td><td>".strtolower(str_replace(array('0', '+', '{', '::', ':', '&', '#'), '', $this->_string))."</td></tr><tr><td>Corrected</td><td>".$this->_string."</td></tr><tr><td>Generated by inflection</td><td>".$this->_orginalString.'</td></tr></table>';
	}
