...
DROP TABLE IF EXISTS `lex_groups`;
CREATE TABLE `lex_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `lex_groups` (`id`, `name`) VALUES
(1,	1);

DROP TABLE IF EXISTS `lex_groups_members`;
CREATE TABLE `lex_groups_members` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lex_group_id` int(11) NOT NULL,
  ...
  KEY `tag_id` (`tag_id`),
  KEY `lex_group_id` (`lex_group_id`),
  CONSTRAINT `lex_groups_members_ibfk_2` FOREIGN KEY (`lexcat_id`) REFERENCES `types` (`id`) ON DELETE CASCADE,
  CONSTRAINT `lex_groups_members_ibfk_3` FOREIGN KEY (`gramcat_id`) REFERENCES `classifications` (`id`) ON DELETE CASCADE,
  CONSTRAINT `lex_groups_members_ibfk_5` FOREIGN KEY (`lex_group_id`) REFERENCES `lex_groups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `lex_groups_members` (`id`, `lex_group_id`, `lexcat_id`, `gramcat_id`, `tag_id`) VALUES
(2,	1,	1,	1,	0);
...
CREATE TABLE `morphology` (
  ...
  `number_optional` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `morphology` (`id`, `name`, `rule`, `number_optional`) VALUES
(4,	'Plural endings -> phonological variable',	'[-en]&EN;',	0),
(5,	'verb, just stem',	'[-en]',	0),
(6,	'verb, stem + t',	'[-en]t',	0),
(7,	'Verb -en plural',	'[-en]en',	0);
...
DROP TABLE IF EXISTS `morphology_gram_groups`;
CREATE TABLE `morphology_gram_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `morphology_id` int(11) NOT NULL,
  `gram_group_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `morphology_id` (`morphology_id`),
  KEY `gram_group_id` (`gram_group_id`),
  CONSTRAINT `morphology_gram_groups_ibfk_1` FOREIGN KEY (`morphology_id`) REFERENCES `morphology` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_gram_groups_ibfk_2` FOREIGN KEY (`gram_group_id`) REFERENCES `gram_groups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `morphology_gram_groups` (`id`, `morphology_id`, `gram_group_id`) VALUES
(3,	4,	1),
(4,	4,	2),
(5,	5,	5),
(6,	6,	6);
...
DROP TABLE IF EXISTS `morphology_lex_groups`;
CREATE TABLE `morphology_lex_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `morphology_id` int(11) NOT NULL,
  `lex_group_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `morphology_id` (`morphology_id`),
  KEY `lex_group_id` (`lex_group_id`),
  CONSTRAINT `morphology_lex_groups_ibfk_1` FOREIGN KEY (`morphology_id`) REFERENCES `morphology` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_lex_groups_ibfk_2` FOREIGN KEY (`lex_group_id`) REFERENCES `lex_groups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `morphology_table`;
CREATE TABLE `morphology_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `morphology_id` int(11) NOT NULL,
  `mode_id` int(11) NOT NULL,
  `submode_id` int(255) NOT NULL,
  ...
  KEY `submode_id` (`submode_id`),
  KEY `number_id` (`number_id`),
  CONSTRAINT `morphology_table_ibfk_1` FOREIGN KEY (`morphology_id`) REFERENCES `morphology` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_table_ibfk_2` FOREIGN KEY (`mode_id`) REFERENCES `modes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_table_ibfk_3` FOREIGN KEY (`submode_id`) REFERENCES `submodes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_table_ibfk_4` FOREIGN KEY (`number_id`) REFERENCES `numbers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `morphology_words`;
CREATE TABLE `morphology_words` (
  ...
  KEY `word_id` (`word_id`),
  KEY `morphology_id` (`morphology_id`),
  CONSTRAINT `morphology_words_ibfk_1` FOREIGN KEY (`word_id`) REFERENCES `words` (`id`) ON DELETE CASCADE,
  CONSTRAINT `morphology_words_ibfk_2` FOREIGN KEY (`morphology_id`) REFERENCES `morphology` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2,	'double consonant before endings',	'CON.VOW_CON_+.VOW=>%%',	0),
(3,	'vowel lengthening before endings',	'CON_[aeou]_CON.+.&T,D=>%%',	0),
(4,	'variable vowel lengthening',	'CON_&A,E,O,U_CON.+.&T,D=>%%',	0),
(5,	'kofschip dental suffix',	'[x,k,f,s,c,h,p].+_&D_=>t',	0),
(6,	'z to s before endings',	'_z_+=>s',	0),
(7,	'VOW.v to f',	'VOW_v_+=>f',	0),
(8,	'no z at word end',	'_z_:>=>s',	0),
(9,	'no v at word end',	'_v_:>=>f',	0),
(10,	'no double b (hebbt -> hebt)',	'CON.VOW._b.b_+.&D,T=>b',	0),
(11,	'no double b (hebbt -> hebt) 2',	'CON.VOW_b.b_+.t=>b',	0),
(12,	'vowel lengthening at word end',	'*.CON_VOW_CON.:>=>%%',	0),
(13,	'variable EE to e before z',	'CON_&EE_z=>e',	0),
(14,	'vowel lengthening 3',	'<:CON._VOW.VOW__CON.+=>$1',	0),
(15,	'trema e',	'VOW.+_e_=>ë',	0),
(16,	's+en → z+en',	'[^r,n]_s_+.e.n=>z',	0),
(19,	'lens => lenzen',	'_l.e.n.s_+.e.n=>lenz',	0),
(20,	'plural phonological context 1',	'[e].[e].[r].[d].[e].+_&EN_=>n',	0),
(21,	'plural dimunitves',	'je.+_&EN_=>s',	0),
(22,	'plural open vowel',	'[aioyu].+_&EN_=>\'s',	0),
(23,	'plural mute e',	'e.+_&EN_=>s',	0),
(24,	'double consonant before plural ending',	'_CON_+.&EN=>%%',	0),
(26,	'endes => enden',	'CON.ende.+_s_=>n',	0),
(27,	'dim ng => nk',	'_ng_+.nkje=>',	0),
(28,	'No double consonants dim',	'VOW_CON_CON.+.je=>',	0),
(29,	'etje => pje if long vowel',	'VOW.VOW.CON.+_&ETJE_=>pje',	0),
(30,	'double consonant before endings 2',	'CON.VOW_CON_+.&E=>%%',	0),
(31,	'fototje => fotootje',	'CON_VOW_+.tje=>%%',	0);
