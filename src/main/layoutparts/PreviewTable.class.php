...
// 	Emma de Roo - MIT License
	//	++		File: PreviewTable.class.php

// Used to build an inflection table

class pPreviewTable extends pLayoutPart {

	private $_output, $_lemma, $_inflCache;

	public function __construct($name, $headings, $rows, $columns, $lemma = null){
		...
		foreach($headings as $heading){
			...
			if(isset($rows[0]) AND $rows[0] == ''){
				$output .= "<tr><td>...</td><td>".TS_NO_ROWS_YET."</td></tr>";
				unset($rows[0]);
			}
